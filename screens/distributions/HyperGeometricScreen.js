...
export default class HyperGeometricScreen extends React.Component {
    constructor() {
        super();
        this.state = { 
            calculate: false,
            ...
            <Content padder>
                <Card>
                    <CardItem header bordered style={{flexDirection: 'column'}}>
                        <Text style={{color: 'blue'}}>Hypergeoemtric Distribution</Text>
                        <Text style={{color: 'black'}}>X ~ Hypergeom(N,n,m)</Text>
                    </CardItem>
                    <CardItem bordered>
                        <Body>
                            <Text>
                                The Hypergeoemtric distribution is ...
                            </Text>
                        </Body>
                    </CardItem>
                    <CardItem bordered>
